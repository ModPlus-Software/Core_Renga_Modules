namespace ModPlus
{
    ...
    public class SettingsViewModel : VmBase
    {
        ...
        /// </summary>
        public bool DisableConnectionWithLicenseServerInRenga
        {
            get => Variables.DisableConnectionWithLicenseServerInRenga;
            set => Variables.DisableConnectionWithLicenseServerInRenga = value;
        }
